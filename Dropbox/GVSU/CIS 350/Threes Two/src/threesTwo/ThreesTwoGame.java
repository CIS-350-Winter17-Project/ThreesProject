...
public class ThreesTwoGame {
	 ...
	 *****************************************************************/
	private boolean moveAvailable(int row, int col,
		...
		if (direction == Direction.UP) {
			...
			if (board[row][col].getValue() >= 3) {
				...
				if (board[row - 1][col].isEmpty() || board[row][col]
						.getValue() == board[row - 1][col].getValue())
					return true;
				return false;
		...
		if (direction == Direction.LEFT) {
			...
			if (board[row][col].getValue() >= 3) {
				...
				if (board[row][col - 1].isEmpty() || board[row][col]
						.getValue() == board[row][col - 1].getValue())
					return true;
